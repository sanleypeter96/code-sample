...
public class SpellCorrect {
	...
	public SpellCorrect() {
		HolbrookCorpus corpus = new HolbrookCorpus(
	...
	public static void eval() {
		...
		// UniformLanguageModel uniformLM = new
		// UniformLanguageModel(trainingCorpus);
		// SpellCorrect uniformSpell = new SpellCorrect(uniformLM,
		// trainingCorpus);
		...
		// LaplaceBigramLanguageModel laplaceBigramLM = new
		// LaplaceBigramLanguageModel(trainingCorpus);
		// SpellCorrect laplaceBigramSpell = new SpellCorrect(laplaceBigramLM,
		// trainingCorpus);
		// SpellingResult laplaceBigramOutcome =
		// laplaceBigramSpell.evaluate(devCorpus);
		// System.out.println(laplaceBigramOutcome.toString());

		// System.out.println("Stupid Backoff Language Model: ");
		// StupidBackoffLanguageModel sbLM = new
		// StupidBackoffLanguageModel(trainingCorpus);
