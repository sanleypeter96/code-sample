...
public class Datum {
	...
	// returns true if the error is within edit distance one and contains no
	...
	public String toString() {
		return String.format(
				"word: \"%s\" error: \"%s\" distance: %d valid: %b", word,
				error, EditDistance.editDistance(word, error, true),
				isValidTest());
	}
}
